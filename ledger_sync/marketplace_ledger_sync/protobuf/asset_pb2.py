...
# source: marketplace_ledger_sync/protobuf/asset.proto
...
from marketplace_ledger_sync.protobuf import rule_pb2 as marketplace__ledger__sync_dot_protobuf_dot_rule__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='marketplace_ledger_sync/protobuf/asset.proto',
  package='',
  syntax='proto3',
  serialized_pb=_b('\n,marketplace_ledger_sync/protobuf/asset.proto\x1a+marketplace_ledger_sync/protobuf/rule.proto\"P\n\x05\x41sset\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x13\n\x0b\x64\x65scription\x18\x02 \x01(\t\x12\x0e\n\x06owners\x18\x03 \x03(\t\x12\x14\n\x05rules\x18\x04 \x03(\x0b\x32\x05.Rule\")\n\x0e\x41ssetContainer\x12\x17\n\x07\x65ntries\x18\x01 \x03(\x0b\x32\x06.Assetb\x06proto3')
  ,
  dependencies=[marketplace__ledger__sync_dot_protobuf_dot_rule__pb2.DESCRIPTOR,])
...
_ASSET = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='description', full_name='Asset.description', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='owners', full_name='Asset.owners', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='rules', full_name='Asset.rules', index=3,
...
_ASSET.fields_by_name['rules'].message_type = marketplace__ledger__sync_dot_protobuf_dot_rule__pb2._RULE
...
Asset = _reflection.GeneratedProtocolMessageType('Asset', (_message.Message,), dict(
  DESCRIPTOR = _ASSET,
  __module__ = 'marketplace_ledger_sync.protobuf.asset_pb2'
