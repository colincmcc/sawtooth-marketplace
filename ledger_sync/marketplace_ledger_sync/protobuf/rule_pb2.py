...
# source: marketplace_ledger_sync/protobuf/rule.proto
...
Rule = _reflection.GeneratedProtocolMessageType('Rule', (_message.Message,), dict(
  DESCRIPTOR = _RULE,
  __module__ = 'marketplace_ledger_sync.protobuf.rule_pb2'
