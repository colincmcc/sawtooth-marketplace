...
# source: marketplace_transaction/protobuf/rule.proto
...
Rule = _reflection.GeneratedProtocolMessageType('Rule', (_message.Message,), dict(
  DESCRIPTOR = _RULE,
  __module__ = 'marketplace_transaction.protobuf.rule_pb2'
