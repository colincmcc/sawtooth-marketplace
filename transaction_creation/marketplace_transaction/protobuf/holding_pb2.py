...
# source: marketplace_transaction/protobuf/holding.proto
...
Holding = _reflection.GeneratedProtocolMessageType('Holding', (_message.Message,), dict(
  DESCRIPTOR = _HOLDING,
  __module__ = 'marketplace_transaction.protobuf.holding_pb2'
