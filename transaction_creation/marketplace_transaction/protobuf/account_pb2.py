...
# source: marketplace_transaction/protobuf/account.proto
...
Account = _reflection.GeneratedProtocolMessageType('Account', (_message.Message,), dict(
  DESCRIPTOR = _ACCOUNT,
  __module__ = 'marketplace_transaction.protobuf.account_pb2'
